...
<!-- date and Gender  -->
    ...
    <small id="emai" class="form-text text-muted mb-4 text-center">
    ...
    <!-- photo uploadfield -->
       ...
       <input type="file" value="" name="pictures" class="form-control" id="upload">

        <!-- Sign up button -->
        <input type='button' class="btn btn-primary my-4 btn-block message_box" name='submit' id="submit" value = 'Sign in'>

        <!-- Social register -->
        <div class="text-center text-primary mt-2"> <a href="login.php">Already A Member ?</a> </div>
                <hr class="my-4">
